...
public class GUILogin2 extends javax.swing.JFrame {
    ...
    private void abrirCadastroLogin() {
        ...
        if (primeiraExecucao) {
            ...
            // ✅ Usa o construtor correto
            GUICadManuLogin cadastro = new GUICadManuLogin(this, 3);
            cadastro.setVisible(true);

        } else {
            // ✅ Usa o mesmo construtor com perfil diferente
            GUICadManuLogin cadastro = new GUICadManuLogin(this, 1);
            cadastro.setVisible(true);
        }
    }
